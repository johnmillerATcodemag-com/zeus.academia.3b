...
internal sealed class ProvisionExtensionSqlServerTestDatabase : IAsyncDisposable
{
  private readonly string _connectionString;

  private ProvisionExtensionSqlServerTestDatabase(string connectionString)
  {
    _connectionString = connectionString;
  }

  public static async Task<ProvisionExtensionSqlServerTestDatabase> CreateAsync()
  {
    var connectionString = ResolveConnectionString();
    var builder = new SqlConnectionStringBuilder(connectionString)
    {
      InitialCatalog = $"ZeusTests_ProvisionExtension_{Guid.NewGuid():N}"
    };

    var database = new ProvisionExtensionSqlServerTestDatabase(builder.ConnectionString);
  ...
  public ProvisionExtensionDbContext CreateContext()
  {
